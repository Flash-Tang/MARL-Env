...
class RLlibStarCraft2Env(rllib.MultiAgentEnv):
    """Wraps a MARL-Env StarCraft env to be compatible with RLlib multi-agent."""
    ...
    def __init__(self, **smac_args):
        ...
        Arguments:
            smac_args (dict): Arguments to pass to the underlying
                MARL-Env.env.starcraft.StarCraft2Env instance.

        Examples:
            >>> from MARL-Env.examples.rllib import RLlibStarCraft2Env
